// New: noise utilities (snoise + fbm) separated for readability and potential reuse

// Simplex noise & fbm implementations adapted from original shader,
// converted to GLSL string fragments so they can be composed into shader source when needed.
